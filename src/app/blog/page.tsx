  ...
  const posts = [
    {
      ...
      path: "blog/release-of-tailwind-nextjs-starter-blog-v2.0",
      filePath: "blog/release-of-tailwind-nextjs-starter-blog-v2.0.mdx",
      toc: [
        {
          value: "Introduction",
          url: "#introduction",
        ...
        {
          value: "New Search Component",
          url: "#new-search-component",
          depth: 2,
        },
        {
          value: "Algolia",
        ...
        {
          value: "Styling and Layout Updates",
          url: "#styling-and-layout-updates",
          depth: 2,
        },
        {
          value: "Theming",
        ...
        {
          value: "Migration Recommendations",
          url: "#migration-recommendations",
          depth: 2,
        },
        {
          value: "Conclusion",
    ...
    },
    {
      ...
      path: "blog/new-features-in-v1",
      filePath: "blog/new-features-in-v1.mdx",
      toc: [
        {
          value: "Overview",
          url: "#overview",
        ...
        {
          value: "Xdm MDX compiler",
          url: "#xdm-mdx-compiler",
          depth: 2,
        },
        {
          value: "Table of contents component",
        ...
        {
          value: "Adding new templates",
          url: "#adding-new-templates",
          depth: 3,
        },
        {
        ...
        {
          value: "Blog comments system",
          url: "#blog-comments-system",
          depth: 2,
        },
        {
          value: "Multiple authors",
          url: "#multiple-authors",
          depth: 2,
        },
        {
        ...
        {
          value: "Copy button for code blocks",
          url: "#copy-button-for-code-blocks",
          depth: 2,
        },
        {
        ...
        {
          value: "Newletter component (v1.1.3)",
          url: "#newletter-component-v113",
          depth: 2,
        },
        {
        ...
        {
          value: "Self-hosted font (v1.5.0)",
          url: "#self-hosted-font-v150",
          depth: 2,
        },
        {
          value: "Upgrade guide",
      ...
      structuredData: {
        ...
        datePublished: "2021-08-07T15:32:14.000Z",
    ...
    },
    {
      ...
      path: "blog/nested-route/introducing-multi-part-posts-with-nested-routing",
      filePath:
        "blog/nested-route/introducing-multi-part-posts-with-nested-routing.mdx",
      toc: [
        {
          value: "Nested Routes",
          url: "#nested-routes",
    ...
    },
    {
      ...
      slug: "my-fancy-title",
      path: "blog/my-fancy-title",
      filePath: "blog/my-fancy-title.mdx",
      toc: [],
      structuredData: {
        "@context": "https://schema.org",
        "@type": "BlogPosting",
        headline: "My fancy title",
        datePublished: "2021-01-31T00:00:00.000Z",
    ...
    },
    {
      ...
      path: "blog/introducing-tailwind-nextjs-starter-blog",
      filePath: "blog/introducing-tailwind-nextjs-starter-blog.mdx",
      toc: [
        {
        ...
        {
          value: "Extend / Customize",
          url: "#extend--customize",
          depth: 2,
        },
        {
          value: "Post",
      ...
      structuredData: {
        ...
        datePublished: "2021-01-12T00:00:00.000Z",
    ...
    },
    {
      ...
      toc: [
        ...
        {
          value: "Deriving the OLS Estimator",
          url: "#deriving-the-ols-estimator",
          depth: 1,
        },
        {
          value: "Least Squares",
    ...
    },
    {
      ...
      path: "blog/github-markdown-guide",
      filePath: "blog/github-markdown-guide.mdx",
      toc: [
        {
          value: "Introduction",
          url: "#introduction",
        ...
        },
        {
          ...
          url: "#this-is-a-h1-tag",
          depth: 1,
        },
        {
          value: "This is a h2 tag",
          url: "#this-is-a-h2-tag",
          depth: 2,
        },
        {
          value: "This is a h4 tag",
          url: "#this-is-a-h4-tag",
          depth: 4,
        },
        {
          value: "Emphasis",
      ...
      structuredData: {
        ...
        datePublished: "2019-10-11T00:00:00.000Z",
    ...
    },
    {
      ...
      path: "blog/the-time-machine",
      filePath: "blog/the-time-machine.mdx",
      toc: [
        {
    ...
    },
    {
      ...
      path: "blog/pictures-of-canada",
      filePath: "blog/pictures-of-canada.mdx",
      toc: [
        {
          value: "Gallery",
          url: "#gallery",
    ...
    },
    {
      ...
      slug: "code-sample",
      path: "blog/code-sample",
      filePath: "blog/code-sample.mdx",
      toc: [
        {
